  ...
  return (
    <section
      className={`absolute top-24 left-0 right-0 z-20 flex flex-col items-center justify-center text-center px-6 py-16 sm:py-24
        bg-[color:var(--color-liturgical-white)]/80 backdrop-blur-md text-[color:var(--color-liturgical-black)] transition-all duration-700
    ...
    >
      ...
      <p className="text-lg sm:text-xl max-w-2xl mb-4">
      ...
      <p className="max-w-xl text-base sm:text-lg mb-4">
      ...
      <a
        ...
        className="flex items-center gap-2 mb-6 underline"
        title="Visit CodexCommunion on GitHub"
      >
      ...
      <div className="bg-gray-100 rounded-md p-4 mb-8 text-left max-w-lg w-full shadow-sm">
        <p className="font-medium mb-2 text-sm uppercase tracking-wide ">Consider these tips on how to start the conversation...</p>
      ...
      <button
        onClick={onStart}
        className="px-6 py-3 rounded-lg text-lg font-medium text-[var(--color-liturgical-white)] bg-[var(--color-marian-blue-500)] hover:bg-[var(--color-marian-blue-600)] transition"
      >
        Start Chatting
      </button>
